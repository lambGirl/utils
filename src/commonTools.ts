 ...
 * @param timeout
 */
export const debounce = (fun: Function | void, timeout = 200): Function => {
 ...
 *  遵循qs的url规则
 */
export const getParamsValue = (urlString: string, name: string): string => {
  if (urlString) {
 ...
 * @param scale
 */
export const toRound = (number: string, scale = '5'): number => {
 ...
 * @param minLength
 */
export const validateLength = (str, maxLength, minLength = 0): boolean => {
 ...
 * @param str
 */
export const isEmptyString = (str: any): boolean => str === null || str === undefined || str === '';
